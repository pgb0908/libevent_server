...
#ifndef LIBEVENT_SERVER_SCHEDULARCALLBACKINTERFACE_H
#define LIBEVENT_SERVER_SCHEDULARCALLBACKINTERFACE_H
...
#endif //LIBEVENT_SERVER_SCHEDULARCALLBACKINTERFACE_H
